package com.sganayon.tutorialmod.fluid;
...
public class ModFluids {
    ...
    public static final RegistryObject<FlowingFluid> FLOWING_SOAP_WATER = FLUIDS.register("flowing_soap_water_fluid", () -> new ForgeFlowingFluid.Flowing(ModFluids.SOAP_WATER_FLUID_PROPERTIES));

    public static final ForgeFlowingFluid.Properties SOAP_WATER_FLUID_PROPERTIES = new ForgeFlowingFluid.
            Properties(ModFluidTypes.SOAP_WATER_FLUID_TYPE, ModFluids.SOURCE_SOAP_WATER, ModFluids.FLOWING_SOAP_WATER)
            .slopeFindDistance(2)
